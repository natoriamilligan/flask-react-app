    ...
    <div>
      ...
      <Nav ref={navRef}>
        ...
        <Stack gap={2} id="nav-stack" className={open ? "active" : "wrapper"}>
          <Nav.Item
            className={location.pathname === "/dashboard" ? "nav-items" : ""}
          >
            <Nav.Link
              as={NavLink}
              to="/dashboard"
              className={
                location.pathname === "/dashboard"
                  ? "nav-link-active nav-links fs-6"
                  : "nav-links fs-6"
              }
            >
              Home
          ...
          <Nav.Item
            className={location.pathname === "/deposit" ? "nav-items" : ""}
          >
            <Nav.Link
              as={NavLink}
              to="/deposit"
          ...
          <Nav.Item
            className={location.pathname === "/withdrawal" ? "nav-items" : ""}
          >
            <Nav.Link
              as={NavLink}
              to="/withdrawal"
          ...
          <Nav.Item
            className={location.pathname === "/transfer" ? "nav-items" : ""}
          >
            <Nav.Link
              as={NavLink}
              to="/transfer"
